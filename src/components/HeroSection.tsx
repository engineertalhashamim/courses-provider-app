  ...
  return (
    ...
    mx-auto py-10 md:py-0 md:h-[41.6rem]'>
      <div className='p-4 relative z-10 w-full text-center'>
        ...
        <p className='mt-4 font-light text-base md:text-lg text-neutral-300 max-w-lg mx-auto'>Dive into our comprehensive music course and master everything from the basics of rhythm and melody to advanced composition, production, and performance techniques.</p>
        <div className='mt-4'>
          <Link href={"/courses"}>
             <Button
